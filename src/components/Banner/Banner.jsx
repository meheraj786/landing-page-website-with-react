...
const Banner = () => {
  return (
    <div className="relative bg-[url(assets/banner.png)] pt-[195px] md:pb-[456px] pb-[250px] bg-cover bg-center bg-no-repeat">
      <Container>
        ...
        <Flex className="relative mt-8 mb-[0px] md:mb-[98px] w-full max-w-[480px] mx-auto">
          <input
        ...
        <img
          className="absolute bottom-[-136px] left-[44%] md:left-[47%] transform -translate-x-1/2 w-[1200px]"
          src={bannerLaptop}
          alt=""
        />
      </Container>
