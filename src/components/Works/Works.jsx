  ...
  return (
    <div className="works py-[140px]">
      <Container>
        ...
        <h2 className='font-primary text-center md:text-[46px] text-[36px] mt-[4px] mb-[50px] md:mb-[80px] font-bold  leading-[58px] text-text'>How It Works</h2>
        <Flex className="md:justify-between">
          {
            works.map((work)=>(
              <div className="group card cursor-pointer hover:bg-primary mx-auto mb-5 md:mb-0  border-1 rounded-[20px] text-text border-[#DCE7FE] p-[36px] w-[330px]">
